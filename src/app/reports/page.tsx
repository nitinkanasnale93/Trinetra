    ...
    <AppShell>
      <div className="flex items-end justify-between gap-6">
        ...
        <button
          ...
          className="flex h-11 items-center gap-2 rounded-xl bg-[var(--navy)] px-4 text-sm font-medium text-white transition hover:opacity-90"
        >
          <Download size={16} />
      ...
      <section className="mt-4 grid grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] gap-4">
        {/* Report Library */}
          ...
          <div className="border-b border-[var(--border)] p-5">
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <select
                ...
                className="h-10 rounded-xl border border-[var(--border)] bg-[var(--background)] px-3 text-xs text-[var(--navy)] outline-none"
              >
        ...
        <aside className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
          ...
          <h2 className="mt-6 text-[23px] font-medium leading-8 tracking-[-0.04em] text-[var(--navy)]">
...
function ReportStat({
  ...
  return (
    <div className="rounded-xl border border-[var(--border)] p-3">
      ...
      <p className="mt-1 truncate text-xs font-medium text-[var(--navy)]">
        {value}
      </p>
    </div>
  );
